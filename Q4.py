...
def coinExchangeScript(public_key_sender, public_key_recipient, hash_of_secret):
    return [
        ...
        OP_ELSE, public_key_sender, OP_CHECKSIG, OP_DROP, public_key_recipient, OP_CHECKSIG,
        OP_ENDIF
    ]
...
def coinExchangeScriptSig2(sig_sender, sig_recipient):
    return [
        # fill this in!
        sig_recipient, sig_sender, False
    ]
######################################################################
...
alice_txid_to_spend     = "1d3fd29a9c59aa51cf3948a2aacb808dbe4b79fdb540103fe93546053eb95e94"
alice_utxo_index        = 0
alice_amount_to_send    = 0.000105

bob_txid_to_spend       = "0c6868f8fdffc09281f96cab49c3d33d0cbef61ff68a746776b720d9962132e2"
bob_utxo_index          = 0
bob_amount_to_send      = 0.000105
...
btc_test3_chain_height  = 2581875

#  curl https://api.blockcypher.com/v1/bcy/test
bcy_test_chain_height   = 1241468
