...
if __name__ == '__main__':
    ...
    private_key = alice_address_BTC
    public_key = private_key.pub
    address = P2PKHBitcoinAddress.from_pubkey(public_key)

    amount_to_send = 0.099 # amount of BTC in the output you're splitting minus fee
    txid_to_spend = (
        '4f4dcc2248350bcd5081682a91f1a286df5cb64eaaa390cb053e9447a3436513')
